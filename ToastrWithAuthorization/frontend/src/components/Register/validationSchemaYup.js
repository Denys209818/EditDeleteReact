...
export default Yup.object({
    ...
    password: Yup.string().min(6, "Мінімальна кількість символів - 6").required("Поле обов'язкове для заповнення!"),
    confirmPassword: Yup.string().required("Поле обов'язкове для заповнення!").oneOf([Yup.ref("password")], "Поля 'Пароль' не співпадають!")
});